...
SELECT Name, HeadOfState FROM world.country;



select distinct Name, Continent from world.country;



select Name, Continent, HeadOfState from world.country;
...
SELECT * FROM world.country
where Population between 120000000 and 210000000;
...
Select * from world.country
where GovernmentForm IN ('Monarchy','US Territory','Dependent Territory of the UK'); 




 select * from world.country
 where Continent = 'Africa' and Region = 'Western Africa';
 
 

select * from world.country
 where Region = 'Eastern Africa' or GovernmentForm = 'Republic';
...
where GNP > 100000;
 ...
 select * from world.country
 order by Population, HeadOfState;
